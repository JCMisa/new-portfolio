...
const ContactSection = () => {
  return (
    <section
      className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-transparent p-5"
      id="contact"
    >
      <DotPattern
        width={20}
      ...
      <div className="flex flex-col items-center">
        ...
        >
          {/* <MagicButton
            ...
            position="right"
          /> */}
          <Button className="flex items-center gap-2 cursor-pointer min-w-52 max-w-52">
